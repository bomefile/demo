 ...
 *
 * 10位的数据机器位，可以部署在1024个节点，dataCenterId<br>
 *
...
public class SnowflakeIdUtil {
    ...
    /** 开始时间截 (2018-08-08) */
    private final long twePoch = 1533657600000L;
    ...
    /**
     * 构造函数
     * @param dataCenterId 数据中心ID (0~1024)
     */
    public SnowflakeIdUtil(long dataCenterId) {
